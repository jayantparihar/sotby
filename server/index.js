...
app.use(function (req, res, next) {
  ...
  res.setHeader(
    ...
    "default-src 'self'; script-src 'unsafe-inline' 'self'; style-src  'unsafe-inline' 'self'; style-src-elem 'unsafe-inline'; script-src-elem 'unsafe-inline' 'self'; font-style 'self'"
  );
  next();
});
