...
app.use(function (req, res, next) {
  ...
  res.setHeader(
    ...
    "default-src 'self'; script-src 'unsafe-inline' 'self'; style-src  'unsafe-inline' 'self'; style-src-elem 'unsafe-inline' 'self'; script-src-elem 'unsafe-inline' ; font-style 'self'"
  );
  next();
});
